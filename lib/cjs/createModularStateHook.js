    ...
    if (!sagas.includes(name)) {
        ...
        sagaMiddleware.run(function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, effects_1.takeLatest(name, saga)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
...
function useModularState(moduleName, initialState, callableMap, store, sagaMiddleware) {
    ...
    var _a = react_1.useState(function () { return getState(moduleName, store); }), moduleState = _a[0], setModuleState = _a[1];
...
exports.default = createUseModularStateHook;
